  ...
  return (
    ...
    >
      <div className="space-y-3 text-center">
        <h1 className="font-outfit text-4xl font-bold tracking-tight text-gray-900">
          Join the community
        </h1>
        <p className="text-sm text-gray-500">
          Experience the next generation of apartment living.
        </p>
      </div>
      ...
      <div className="rounded-[2rem] border border-gray-100 bg-white p-8 shadow-2xl shadow-gray-200/50">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          {error && (
            <motion.div
              ...
              className="flex items-center gap-2 rounded-2xl border border-red-100 bg-red-50/50 p-4 text-sm text-red-600 backdrop-blur-sm"
            >
        ...
        <div className="my-8 flex items-center gap-4">
          ...
          <span className="px-2 text-xs font-bold tracking-widest whitespace-nowrap text-gray-400 uppercase">
            Social Sign Up
          </span>
          <div className="h-px w-full bg-gradient-to-r from-transparent via-gray-200 to-transparent" />
        </div>
        ...
        <a
          ...
          className="flex h-12 w-full items-center justify-center gap-3 rounded-xl border border-gray-100 bg-white font-bold text-gray-700 transition-all duration-200 hover:bg-gray-50 hover:shadow-md active:scale-[0.98]"
        >
