...
export default function Footer() {
  ...
  return (
    <footer
      id="contact"
      className="border-t border-gray-100 bg-white pt-24 pb-12"
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid gap-12 md:grid-cols-4 lg:gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="max-w-sm leading-relaxed font-medium text-gray-600">
              Modern community management platform that brings efficiency,
              transparency, and security to residential communities.
            </p>
          </div>
