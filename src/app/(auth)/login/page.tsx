                    ...
                    <div className="space-y-8 flex-1 flex flex-col justify-center py-8">
                        ...
                        <div className="space-y-3">
                            <h2 className="text-4xl font-black text-white leading-tight font-outfit tracking-tighter">
                                Community <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 via-teal-200 to-emerald-300">Simplified.</span>
                            </h2>
                            <p className="text-emerald-50/50 text-sm font-medium px-4">The ultimate platform for modern residential management.</p>
                        </div>
