    ...
    try {
        ...
        if (userRole === 'ADMIN' || userRole === 'SUPER_ADMIN') {
            ...
            const [
                ...
                // Prioritize pinned or Event/Meeting announcements
            ...
            // Optimize monthly revenue chart: single aggregation if possible, but loop is okay for 6 items.
