...
export async function GET(request: NextRequest) {
    try {
        ...
        } else if (queryUserId && (user.role === 'ADMIN' || user.role === 'SUPER_ADMIN')) {
...
export async function POST(request: NextRequest) {
    try {
        ...
        const { userId, amount, type, description, dueDate, paymentMethod, transactionId } = body;
        ...
        const status = (paymentMethod && transactionId) ? PaymentStatus.COMPLETED : PaymentStatus.PENDING;
